//
// Created by jason on 3/15/21.
//

#ifndef UWASM_VM_U_LEB128_H
#define UWASM_VM_U_LEB128_H
...
inline unsigned encodeSLEB128(int64_t Value, std::ostream  &OS,
                              unsigned PadTo = 0) {
    bool More;
    unsigned Count = 0;
    do {
...
/// the length in bytes of the encoded value.
inline unsigned encodeULEB128(uint64_t Value, std::ostream &OS,
                              unsigned PadTo = 0) {
    unsigned Count = 0;
    do {
        uint8_t Byte = Value & 0x7f;
